...
export function createServer() {
  ...
  server.registerResource(
    ...
    {
      title: '브랜드 톤앤매너',
      description: '뉴스레터 작성 시 사용하는 디지털프레소 문체/표현 가이드',
      mimeType: 'text/markdown',
    },
    async () => ({
      contents: [{
        uri: 'brand-voice://content',
        text: brandVoice,
        mimeType: 'text/markdown',
      }],
    })
  ...
  server.registerResource(
    ...
    {
      title: '타깃 고객 프로필',
      description: '핵심 고객군/페인포인트/도입 관심 포인트',
      mimeType: 'text/markdown',
    },
    async () => ({
      contents: [{
  ...
  server.registerResource(
    ...
    {
      title: '검증 포인트',
      description: '제품 메시지에 활용할 수 있는 검증 포인트 및 수치 사용 가이드',
      mimeType: 'text/markdown',
    },
    async () => ({
      contents: [{
        uri: 'proof-points://content',
        text: proofPoints,
        mimeType: 'text/markdown',
      }],
    })
  ...
  server.registerResource(
    ...
    {
      title: 'CTA 정책',
      description: '뉴스레터 말미 CTA 문구 및 톤 가이드',
      mimeType: 'text/markdown',
    },
    async () => ({
      contents: [{
        uri: 'cta-policy://content',
        text: ctaPolicy,
        mimeType: 'text/markdown',
      }],
    })
  ...
  server.registerResource(
    'claims-guard',
    'claims-guard://content',
    {
      title: '표현 안전 가이드',
      description: '출처/기자명 노출 금지, 과장 방지 등 표현 안전 규칙',
      mimeType: 'text/markdown',
    },
    async () => ({
      contents: [{
        uri: 'claims-guard://content',
        text: claimsGuard,
        mimeType: 'text/markdown',
      }],
    })
