      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <div className={styles.body}>
            ...
            <p className={styles.articleTitle}>제1조 (개인정보의 처리목적)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제2조 (개인정보의 처리 및 보유기간)</p>
            <p>
            ...
            <p>- 가입자 전기통신일시, 개시·종료 시간, 상대방 가입자 번호, 사용도수, 발신기지국 위치추적자료 : 1년</p>
            <p>- 컴퓨터 통신, 인터넷 로그 기록자료, 접속지 추적자료 : 3개월</p>

            <p className={styles.articleTitle}>제3조 (개인정보의 제3자 제공)</p>
            <p>
            ...
            <p>- 제공받는 자의 개인정보 이용목적 : {'<'}예) 이벤트 공동개최 등 업무제휴 및 제휴 신용카드 발급{'>'}</p>
            <p>- 제공하는 개인정보 항목 : {'<'}예) 성명, 주소, 전화번호, 이메일주소, 카드결제계좌정보{'>'}</p>
            <p>- 제공받는 자의 보유, 이용기간 : {'<'}예) 신용카드 발급계약에 따른 거래기간동안{'>'}</p>

            <p className={styles.articleTitle}>제4조(개인정보처리의 위탁)</p>
            <p>
              ① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
            </p>
            <p>- 위탁업무 내용</p>
            <p>- 위탁받는 자 (수탁자) : (주)아임웹</p>
            <p>- 위탁하는 업무의 내용 : 쇼핑몰 호스팅 서비스의 시스템 제공, 모바일 앱 서비스, 마케팅 서비스 및 부가, 제휴서비스 제공 및 알림톡, 친구톡, 문자메시지 발송대행 서비스 등</p>
            ...
            <p>- 위탁하는 업무의 내용 : 문자메시지 발송, 카카오톡 알림톡(정보성 메시지) 및 친구톡 발송 업무</p>
            <p>
            ...
            <p className={styles.articleTitle}>제5조(정보주체 및 법정대리인의 권리와 그 행사 방법)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제6조(처리하는 개인정보 항목)</p>
            <p>회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
            <p>1. 홈페이지 회원 가입 및 관리</p>
            <p>필수항목 : {'<'}예) 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 성별, 이메일주소, 아이핀번호{'>'}</p>
            <p>선택항목 : {'<'}예) 결혼 여부, 관심 분야{'>'}</p>
            <p>2. 재화 또는 서비스 제공</p>
            <p>필수항목 : {'<'}예) 성명, 생년월일, 아이디, 비밀번호, 주소, 전화번호, 이메일주소, 아이핀번호, 신용카드번호, 은행계좌정보 등 결제정보{'>'}</p>
            <p>선택항목 : {'<'}관심분야, 과거 구매내역{'>'}</p>

            <p className={styles.articleTitle}>제7조(개인정보의 파기)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제8조(개인정보의 안전성 확보조치)</p>
            <p>회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 하고 있습니다.</p>
            <p>1. 관리적 조치 : 내부관리계획 수립 및 시행, 정기적 직원 교육 등</p>
            <p>2. 기술적 조치 : 개인정보처리시스템 등의 접근 권한 관리, 접근통제시스템 설치, 고유 식별정보 등의 암호화, 보안프로그램 설치</p>
            <p>3. 물리적 조치 : 전산실, 자료보관실 등의 접근통제</p>

            <p className={styles.articleTitle}>제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</p>
            <p>
            ...
            <p>- 크롬(Chrome) : 웹 브라우저 설정 {'>'} 개인정보 보호 및 보안 {'>'} 인터넷 사용기록 삭제</p>
            <p>- 엣지(Edge) : 웹 브라우저 설정 {'>'} 쿠키 및 사이트 권한 {'>'} 쿠키 및 사이트 데이터 관리 및 삭제</p>
            <p>▶ 모바일 브라우저에서 쿠키 허용/차단</p>
            <p>- 크롬(Chrome) : 모바일 브라우저 설정 {'>'} 개인정보 보호 및 보안 {'>'} 인터넷 사용기록 삭제</p>
            <p>- 사파리(Safari) : 모바일 기기 설정 {'>'} 사파리(Safari) {'>'} 고급 {'>'} 모든 쿠키 차단</p>
            <p>- 삼성 인터넷 : 모바일 브라우저 설정 {'>'} 인터넷 사용 기록 {'>'} 인터넷 사용 기록 삭제</p>
            <p>
              ④ 회사는 서비스 이용과정에서 사용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 수집·이용하고 있습니다.
            </p>

            <p className={styles.articleTitle}>제10조(개인정보 보호책임자)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제11조(개인정보 열람청구)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제12조(권익침해 구제 방법)</p>
            <p>
            ...
            <p className={styles.articleTitle}>제13조(개인정보 처리방침 시행 및 변경)</p>
